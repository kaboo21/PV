...
namespace Chapter_6._5
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Students with grades "2" or lower
            for (int i = 0; i < students.Length; i++)
            {
                if (students[i].math < 3 || students[i].computerScience < 3 || students[i].philosophy < 3 ||
                    students[i].physicalEducation < 3)
                {
                    students[i].Info();
